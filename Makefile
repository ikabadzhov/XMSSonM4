...
COMMONSOURCES=mupq/common/fips202.c mupq/common/sha2.c #mupq/common/sp800-185.c #mupq/common/gimli_hash.c mupq/common/keccakP800/KeccakSpongeWidth800.c
COMMONSOURCES_HOST=$(COMMONSOURCES) mupq/pqclean/common/aes.c #mupq/common/keccakf1600.c
#COMMONSOURCES_M4=$(COMMONSOURCES) common/keccakf1600.S mupq/common/aes.c common/aes.S 
COMMONSOURCES_M4=$(COMMONSOURCES) mupq/common/aes.c common/aes.S #common/keccakf1600.S mupq/common/aes.c common/aes.S common/gimli.S common/KeccakP-800-u2-armv7m-le-gcc.S
